...
const resumeCampaign = () => {
    if (!confirm('Resume sending to pending recipients only? Addresses that already received this message will not be sent again.')) {
        return;
    }
    resuming.value = true;
    ...
    <div class="space-y-4">
        ...
        >
            <AlertDescription class="text-sm">
                ...
                {{ explicitLeadCount.toLocaleString() }} if some leads are missing an email address or have opted out of {{ channelLabel }}.
