...
const submit = () => {
    form.post(route('marketing.campaign-alerts.store'));
};
</script>

<template>
    <Head title="Create Campaign Alert" />
    ...
    <div class="space-y-4">
        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-lg font-semibold tracking-tight">Create Campaign Alert</h1>
                <p class="text-xs text-muted-foreground">Set up alerts to monitor campaign performance</p>
            </div>
        </div>
        ...
        <form @submit.prevent="submit" class="space-y-4">
            <Card>
                ...
                <CardContent class="p-4 space-y-4">
                    <div class="space-y-1.5">
                        <Label for="name" class="text-xs">Alert Name <span class="text-red-500">*</span></Label>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="space-y-1.5">
                            <Label for="alert_type" class="text-xs">Alert Type <span class="text-red-500">*</span></Label>
                            <DropdownMenu>
                                <DropdownMenuTrigger as-child>
                                    <Button variant="outline" class="w-full justify-between text-xs h-8">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div class="space-y-1.5">
                            <Label for="threshold_value" class="text-xs">Threshold Value <span class="text-red-500">*</span></Label>
            ...
            <div class="flex items-center justify-end gap-2">
                <Button type="button" variant="outline" size="sm" as-child>
                    <Link :href="route('marketing.campaign-alerts.index')">Cancel</Link>
                </Button>
