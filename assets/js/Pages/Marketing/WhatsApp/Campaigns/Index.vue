                            ...
                            <tr v-for="campaign in campaigns.data" :key="campaign.id" class="hover:bg-muted/30 transition-colors">
                                <td class="px-3 py-2">
                                    <div class="flex items-center gap-2">
                                        <div class="w-8 h-8 bg-emerald-500 rounded-lg flex items-center justify-center text-white shrink-0 text-lg">📱</div>
                                        <div class="min-w-0">
                                ...
                                <td class="px-3 py-2 text-xs font-medium text-emerald-600 dark:text-emerald-400">{{ campaign.total_cost ? `৳${Number(campaign.total_cost).toFixed(2)}` : '৳0.00' }}</td>
                                <td class="px-3 py-2">
                                    <div class="flex items-center justify-center gap-1">
                                        <Button variant="ghost" size="icon" class="h-7 w-7" as-child>
                                            <Link :href="campaignShow(campaign.id)"><Eye class="h-3.5 w-3.5 text-emerald-600" /></Link>
                                        </Button>
