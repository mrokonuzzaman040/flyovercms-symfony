        ...
        <div class="flex items-center gap-3">
            ...
            <div class="min-w-0">
                ...
                <p class="text-xs text-muted-foreground">
                    ...
                    <Link :href="indexRoute()" class="text-emerald-600 hover:underline dark:text-emerald-400">Back to list</Link>
                </p>
            </div>
        </div>

        <form @submit.prevent="submit" class="space-y-6">
            <ChannelCampaignDetailsCard :form="form" accent="emerald" :packages="packages" :services="services" />
            ...
            <div class="flex flex-col-reverse items-stretch justify-end gap-2 pt-2 sm:flex-row sm:items-center">
                ...
                <Button type="submit" size="sm" :disabled="form.processing" class="gap-1.5 bg-emerald-600 text-white hover:bg-emerald-700">
