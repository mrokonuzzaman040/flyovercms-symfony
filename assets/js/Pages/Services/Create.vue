...
<template>
    ...
    <div class="space-y-4">
        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-lg font-semibold tracking-tight">Create New Service</h1>
                <p class="text-xs text-muted-foreground">Add a new visa or tour service to the system</p>
            </div>
        </div>
