        ...
        <form @submit.prevent="submit">
            <Card class="max-w-2xl">
                <CardHeader>
                    ...
                    <CardDescription>Enter the permission information.</CardDescription>
                </CardHeader>
                <CardContent class="space-y-4">
                    <div class="grid gap-4 sm:grid-cols-2">
                        <div class="space-y-2">
                            <Label for="name">Name</Label>
                            <Input id="name" v-model="form.name" @input="generateSlug" placeholder="e.g., View Users" :class="{ 'border-destructive': form.errors.name }" />
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-xs text-muted-foreground">Group permissions together for easier management.</p>
                    </div>
                    <div class="space-y-2">
